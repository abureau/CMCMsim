...
write.table(res.sub,"res_reg.tex",row.names=F,quote=F,sep="&")
...
power.res = cbind(rep(c("$X_1 x G^M$","$X_1 x G^C$"),5),round(100*c(power.indep01.vec,power.indep01.haplin.vec)),round(100*c(power.dep01.vec,power.dep01.haplin.vec)))
